...
Listado.prototype.obtenerUbicaciones = function() {
    ...
    return this.eliminaRepetidos(ciudades).sort();
}
...
Listado.prototype.obtenerRubros = function() {
    ...
    return this.eliminaRepetidos(rubros).sort();
}
...
Listado.prototype.obtenerHorarios = function() {
    ...
    var horarios = [];
    arregloHorarios.forEach(function(element) {
        element.forEach(function(hor) {
            horarios.push(hor)
        });
    });
    ...
    return this.eliminaRepetidos(horarios).sort();
}

Listado.prototype.eliminaRepetidos = function(listaElementos) {
