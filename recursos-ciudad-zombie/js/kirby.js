...
var kirby = function(sprite, x, y, ancho, alto, velocidad, rangoMov) {
  /* kirby llama al constructor de Enemigo utilizando los parametros
  necesarios */
  Enemigo.call(this, sprite, x, y, ancho, alto, velocidad, rangoMov);
}
/* Completamos la creacion del objeto asignando su prototipo y la funcion
constructor para poder usarla con 'new' al crear nuevos KIRBIES */
kirby.prototype = Object.create(Enemigo.prototype);
kirby.prototype.constructor = kirby;

kirby.prototype.mover = function() {
...
// del zombie caminante habra que reimplementar este metodo desde el objeto kirby

kirby.prototype.atacar = function(jugador) {
